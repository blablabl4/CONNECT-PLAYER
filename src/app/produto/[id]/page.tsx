...
const DEMO_PRODUCTS: Record<string, Product> = {
    '1': {
        ...
        variations: [
            { id: 'v1', name: 'Netflix Compartilhada', description: 'Disponível (8)', price: 7.99, original_price: 11.99, discount: 33, duration: '30 dias', stock: 8, badge: 'Mais Vendido' },
            { id: 'v2', name: 'Netflix Compartilhada', description: 'Disponível (5)', price: 7.99, original_price: 10.99, discount: 23, duration: '30 dias', stock: 5 },
            { id: 'v3', name: 'Netflix Privada', description: 'Completo', price: 17.99, original_price: 24.99, discount: 28, duration: '30 dias', stock: 3 },
        ],
    ...
    '2': {
        ...
        variations: [
            { id: 'v1', name: 'Spotify Individual', description: 'Disponível (12)', price: 5.99, original_price: 9.99, discount: 40, duration: '30 dias', stock: 12, badge: 'Mais Vendido' },
            { id: 'v2', name: 'Spotify Família', description: 'Disponível (4)', price: 8.99, original_price: 14.99, discount: 40, duration: '30 dias', stock: 4 },
            { id: 'v3', name: 'Spotify Premium Privado', description: 'Conta própria', price: 14.99, original_price: 21.90, discount: 32, duration: '30 dias', stock: 6 },
        ],
        created_at: '', updated_at: '',
    },
    '3': {
        ...
        variations: [
            { id: 'v1', name: 'Disney+ Compartilhada', description: 'Disponível (6)', price: 6.99, original_price: 10.99, discount: 36, duration: '30 dias', stock: 6, badge: 'Popular' },
            { id: 'v2', name: 'Disney+ Privada', description: 'Conta própria', price: 15.99, original_price: 22.99, discount: 30, duration: '30 dias', stock: 3 },
        ],
        created_at: '', updated_at: '',
    },
    '4': {
        ...
        variations: [
            { id: 'v1', name: 'IPTV Mensal', description: 'Disponível', price: 19.99, original_price: 29.99, discount: 33, duration: '30 dias', stock: 50, badge: 'Mais Vendido' },
            { id: 'v2', name: 'IPTV Trimestral', description: '3 meses', price: 49.99, original_price: 89.99, discount: 44, duration: '90 dias', stock: 30 },
            { id: 'v3', name: 'IPTV Semestral', description: '6 meses', price: 89.99, original_price: 179.99, discount: 50, duration: '6 meses', stock: 20, badge: 'Melhor Custo' },
            { id: 'v4', name: 'IPTV Anual', description: '12 meses', price: 149.99, original_price: 359.99, discount: 58, duration: '1 ano', stock: 10 },
        ],
        created_at: '', updated_at: '',
    },
    '5': {
        ...
        variations: [
            { id: 'v1', name: 'HBO Compartilhada', description: 'Disponível (7)', price: 7.99, original_price: 11.99, discount: 33, duration: '30 dias', stock: 7, badge: 'Popular' },
            { id: 'v2', name: 'HBO Privada', description: 'Conta própria', price: 16.99, original_price: 24.99, discount: 32, duration: '30 dias', stock: 4 },
        ],
        created_at: '', updated_at: '',
    },
    '6': {
        ...
        variations: [
            { id: 'v1', name: 'Crunchyroll Fan', description: 'Disponível (10)', price: 5.99, original_price: 9.99, discount: 40, duration: '30 dias', stock: 10, badge: 'Popular' },
            { id: 'v2', name: 'Crunchyroll Mega Fan', description: 'Disponível (5)', price: 8.99, original_price: 14.99, discount: 40, duration: '30 dias', stock: 5 },
        ],
        created_at: '', updated_at: '',
    },
};
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className="pd-var-pricing">
                                                {v.discount > 0 && <span className="pd-var-old">R$ {v.original_price.toFixed(2)}</span>}
                        ...
                        <div className="pd-cell pd-cell-info">
                            <div className="pd-info-header">
                                ...
                                <div className="pd-info-price-row">
                                    {discount > 0 && <span className="pd-info-old">R$ {originalPrice.toFixed(2)}</span>}
                                    {discount > 0 && <span className="pd-info-discount">-{discount}%</span>}
